...
--
-- Host: localhost
-- Generation Time: Oct 08, 2018 at 08:41 PM
...
(1, 'jaune_contour.png', 'Files/', '2018-09-25 21:53:53', '2018-09-25 21:53:53', 1);

-- --------------------------------------------------------

--
-- Table structure for table `files_patients`
--

CREATE TABLE IF NOT EXISTS `files_patients` (
...
--
-- Dumping data for table `files_patients`
--

INSERT INTO `files_patients` (`file_id`, `patient_id`, `id`) VALUES
(1, 1, 1);
...
(1, 3, 'Arthur', 'Tremble', 'Male', '2013-09-10', 'ASDF@hotmail.com', '2018-09-10 15:52:47', '2018-09-25 22:02:09', 'Arthur', 2),
...
CREATE TABLE IF NOT EXISTS `Users` (
  ...
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'secretaireNC',
...
INSERT INTO `Users` (`id`, `email`, `password`, `username`, `created`, `modified`, `type`, `uuid`) VALUES
...
(11, 'TestUUID@gmail.com', '$2y$10$/MDSj14cz2dlBmoyEEtruO0KkjkiunKdvP0pkyy9PTtDtuvMg.pmu', 'testuuid', '2018-10-08 19:18:42', '2018-10-08 19:18:42', 'visiteur', '5d4cd4bb-1be9-4ed5-bfb1-e611fa118457'),
(12, 'testuuid2@gmail.com', '$2y$10$S2Vx1pXkrdxgQXD1lkF9L.M3k82p48.XmE8.thD9qmJqu7z3tnDAW', 'qwerty', '2018-10-08 19:48:42', '2018-10-08 19:48:42', 'visiteur', '993cfa47-731a-43d8-99de-865eb685eca7'),
(13, 'testuuidddd@gmail.com', '$2y$10$DWvYoNxqiqfTMWmWxqht9ObKf0uIB5NcY0UDjsa6IqYtVrplssm2.', 'qwerty2', '2018-10-08 19:51:39', '2018-10-08 19:51:39', 'visiteur', '5fe17472-b7f7-464a-8d69-7e6e8249a100'),
(14, 'testX@gmail.com', '$2y$10$iQETH9Ymq6jxTn.ACOyFUOokIptKPeUUcp4vko5phccX3sXA30/32', 'TestX', '2018-10-08 19:53:53', '2018-10-08 19:53:53', 'visiteur', 'ef29c8ec-4f44-4309-812c-296823233f39'),
(16, 'williamsarrazin@msn.com', '$2y$10$AhnmjDsMsFJlH6V5AZJhye68WhQfnLJFVZ42CsUhLEquxN0.N6NlO', 'Will', '2018-10-08 19:59:59', '2018-10-08 20:00:41', 'secretaire', '5029a797-3997-48c5-bdf3-ae5388f13325');
...
--
-- Indexes for table `files_patients`
--
ALTER TABLE `files_patients`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `files`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `files_patients`
--
ALTER TABLE `files_patients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
-- Constraints for table `files_patients`
--
ALTER TABLE `files_patients`
  ADD CONSTRAINT `files_patients_ibfk_1` FOREIGN KEY (`file_id`) REFERENCES `files` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `files_patients_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `Patients` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

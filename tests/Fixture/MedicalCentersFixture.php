...
class MedicalCentersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'director' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'medical_centers_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['Users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-09-08 18:55:09',
                'modified' => '2018-09-08 18:55:09',
                'user_id' => 1
            ],
        ];
        parent::init();
